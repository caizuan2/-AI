...
assert.match(androidJob, /Restore Android debug keystore cache/);
assert.match(androidJob, /actions\/cache@v4/);
assert.match(androidJob, /~\/\.android\/debug\.keystore/);
assert.match(androidJob, /android-debug-keystore-v1/);
assert.match(androidJob, /Ensure Android debug keystore/);
assert.match(androidJob, /keytool -genkeypair/);
assert.match(androidJob, /androiddebugkey/);
assert.match(androidJob, /-storepass android/);
assert.match(androidJob, /-keypass android/);
assert.match(androidJob, /Reusing cached Android debug keystore/);
assert.match(androidJob, /Android debug keystore is empty or missing/);
assert.match(androidBuildGradle, /signingConfig signingConfigs\.debug/);
assert.doesNotMatch(workflow, /KEYSTORE_BASE64/);
assert.doesNotMatch(workflow, /KEYSTORE_PASSWORD/);
assert.doesNotMatch(workflow, /KEY_ALIAS/);
assert.doesNotMatch(workflow, /KEY_PASSWORD/);
...
assert.match(androidJob, /Checking APK signature/);
assert.match(androidJob, /Checking APK certificate/);
