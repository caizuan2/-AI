          ...
          setMessages((current) => current.map((message) => {
            ...
            if (message.id === nextAssistantMessage.id) {
              ...
              return {
                ...
                rawContent: streamResult.rawAnswerBeforeFinalizer ?? streamResult.rawContent ?? streamResult.rawText ?? streamResult.rawAnswer ?? null,
                rawText: streamResult.rawAnswerBeforeFinalizer ?? streamResult.rawText ?? streamResult.rawAnswer ?? null,
                ...
                metadata: {
                  ...
                  rawContent: streamResult.rawAnswerBeforeFinalizer ?? streamResult.rawContent ?? streamResult.rawText ?? streamResult.rawAnswer ?? currentMetadata.rawContent ?? null,
                  rawText: streamResult.rawAnswerBeforeFinalizer ?? streamResult.rawText ?? streamResult.rawAnswer ?? currentMetadata.rawText ?? null,
