[Setup]
AppId={{8D8F7FEF-32F4-4E7D-B8E3-A10900000109}
AppName=AI知识库助手
AppVersion=1.0.9
...
[Files]
Source: "D:\XT\releases\1.0.9\windows-runtime\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
