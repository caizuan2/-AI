...
export function AiCoachAnalyzePage() {
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      <div><p className="text-sm font-medium text-indigo-700">AI 员工教练系统</p><h1 className="mt-1 text-3xl font-semibold tracking-tight">客户沟通分析</h1><p className="mt-2 text-sm leading-6 text-slate-600">结合员工可访问知识、企业行业标准和评分规则，生成每日成长报告。</p></div>
