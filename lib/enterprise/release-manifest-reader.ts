...
export function normalizeReleaseArtifact(
  ...
  return {
    ...
    url: readString(record.downloadUrl) ?? readString(record.url) ?? readString(record.webUrl),
    downloadUrl: readString(record.downloadUrl) ?? readString(record.url),
    latestDownloadUrl: readString(record.latestDownloadUrl),
    assetName: readString(record.assetName),
