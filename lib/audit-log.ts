...
export type AuditAction =
  ...
  | "demote_user_role"
  | "enable_user"
  | "expert_catalog.agent.archive"
  | "expert_catalog.agent.create"
  | "expert_catalog.agent.update"
  | "expert_catalog.zone.archive"
  | "expert_catalog.zone.create"
  | "expert_catalog.zone.update"
