...
const NAMED_SECRET_PATTERN = /(OPENAI_API_KEY|QWEN_API_KEY|DEEPSEEK_API_KEY|OPENROUTER_API_KEY|ANTHROPIC_API_KEY|DATABASE_URL|DIRECT_URL|SESSION_SECRET|LICENSE_SECRET|ADMIN_TOKEN)=([^&\s]+)/gi;
