...
const releaseManifest = {
  ...
  exe: {
    ...
    installerType: exeManifest.installerType || null,
    productName: exeManifest.productName || null,
    internalVersion: exeManifest.internalVersion || null,
    internalBuild: Number(exeManifest.internalBuild) || null,
    internalWebReleaseSha: exeManifest.internalWebReleaseSha || null,
