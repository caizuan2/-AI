...
function normalizeArtifact(name, manifest, releaseHead) {
  ...
  return {
    ...
    internalVersion: manifest.internalVersion || null,
    internalBuild: Number(manifest.internalBuild) || null,
    internalWebReleaseSha: manifest.internalWebReleaseSha || null,
