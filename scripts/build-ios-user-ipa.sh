...
OUTPUT_DIR="$ROOT/dist-app/ios"
ARCHIVE_PATH="$OUTPUT_DIR/AIKnowledgeChat.xcarchive"
EXPORT_DIR="$OUTPUT_DIR/export"
EXPORT_OPTIONS="$OUTPUT_DIR/exportOptions.plist"
FINAL_IPA="$OUTPUT_DIR/ai-knowledge-chat.ipa"
LATEST_IPA="$OUTPUT_DIR/ai-knowledge-chat-latest.ipa"
CONFIG_FILE="capacitor.ios.user.config.ts"
APP_ID="com.aiknowledge.chat"
